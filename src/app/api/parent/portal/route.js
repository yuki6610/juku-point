...
export async function GET(request) {
  try {
    ...
    const [shared, sharedYear,profile,courseSessionDocs,courseApplicationDocs,interviewSlotDocs] = await Promise.all([
      readSharedPortal(),
      readSharedYear(year),

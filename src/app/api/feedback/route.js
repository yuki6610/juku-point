...
async function identity(request){
  ...
  const[admin,parent,user]=await Promise.all([adminDb.collection('admins').doc(uid).get(),adminDb.collection('parentAccounts').doc(uid).get(),adminDb.collection('users').doc(uid).get()]);

...
const guides = [
  {
    ...
    body: (
      <ul>
        <li>宿題提出：+50pt</li>
        <li>宿題途中：-25pt</li><li>宿題未提出：-50pt</li>
        <li>単語テスト：正答率70%以上で+50〜166pt、70%未満は0pt</li>
        <li>自習：10分ごとに+5pt</li>
        <li>成績入力：志望校判定や学習状況の確認に使用</li>
  ...
  },
  {
    ...
    body: <><p>先生の確認後にポイントが反映されます。</p><p>宿題は教材ごとに確認し、全て提出なら+50pt、途中があれば-25pt、一つでも未提出なら-50ptです。単語の再テストにはポイントが付きません。</p></>,
  },
  {
    icon: "◇",
    title: "景品交換",
  ...
  },
  {
    ...
    body: <><h3>中学生</h3><p>成績・志望校判定、宿題、単語テスト、生活態度を利用できます。</p><h3>高校生</h3><p>自習記録、景品交換、ランキング、ポイント履歴を利用できます。</p></>,
  },
  {
    icon: "☺",
    title: "アバター",

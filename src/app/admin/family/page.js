...
const tabs = [
  { id: "interviews", label: "面談予約" },
  { id: "announcements", label: "お知らせ・資料" },
  { id: "events", label: "カレンダー予定" },
  { id: "referrals", label: "友人紹介" },
];
export default function FamilyPage() {
  ...
  return <main className="admin-hub-page"><header className="admin-hub-heading"><span>生徒・保護者</span><h1>保護者対応</h1><p>面談申請と、保護者へ届ける情報を管理します。</p></header><AdminHubTabs label="保護者対応メニュー" tabs={tabs} active={tab} onChange={select}/><div className="admin-hub-content">

...
export default function CourseLessonsPage() {
  ...
  return <main className="course-lessons-page"><header><div><small>COURSE MANAGEMENT</small><h1>講習授業管理</h1><p>申込、受講コマ数、日程調整、確定までを管理します。</p></div><a href="/admin">管理画面へ戻る</a></header>{notice && <p role="status">{notice}</p>}
